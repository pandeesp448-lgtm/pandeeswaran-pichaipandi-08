...
// ═══════════════════════════════════════════════════════════════
// ENHANCED CARD ANIMATIONS (premium motion)
// ═══════════════════════════════════════════════════════════════

export const cardHoverLiftGlow = {
  whileHover: { 
    y: -12,
    boxShadow: "0 30px 60px rgba(210, 180, 140, 0.3)",
    scale: 1.02
  },
...
export const cardHoverScaleGlow = {
  whileHover: { 
    scale: 1.05,
    boxShadow: "0 30px 60px rgba(210, 180, 140, 0.3)"
  },
...
export const cardRotateIn = {
  hidden: { opacity: 0, scale: 0.8, rotate: -5, filter: "blur(10px)" },
  visible: {
    opacity: 1,
    scale: 1,
    rotate: 0,
